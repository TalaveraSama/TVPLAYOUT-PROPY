# Empaquetar Nexora Air V25.5.0 para Windows
...
```text
dist/Setup_NexoraAir_V25.5.0.exe
dist/Setup_NexoraAir_V25.5.0.exe.sha256
```

El Setup contiene, sin instalaciones manuales en el equipo destino:

- Nexora Air V25.5.0 y los launchers `NexoraAir.exe` / `NexoraAir-Console.exe`.
