# Empaquetar Nexora Air V25.3.1 para Windows
...
```text
dist/Setup_NexoraAir_V25.3.1.exe
dist/Setup_NexoraAir_V25.3.1.exe.sha256
```

El Setup contiene, sin instalaciones manuales en el equipo destino:

- Nexora Air V25.3.1 y los launchers `NexoraAir.exe` / `NexoraAir-Console.exe`.
