# Empaquetar Nexora Air V25.3.2 para Windows
...
```text
dist/Setup_NexoraAir_V25.3.2.exe
dist/Setup_NexoraAir_V25.3.2.exe.sha256
```

El Setup contiene, sin instalaciones manuales en el equipo destino:

- Nexora Air V25.3.2 y los launchers `NexoraAir.exe` / `NexoraAir-Console.exe`.
