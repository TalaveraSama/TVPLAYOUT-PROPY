@echo off
REM ====================================================================
REM   TVPlayout PRO V24.0.1.7 - Generador de ejecutable
...
echo ================================================
echo   TVPlayout PRO V24.0.1.7 - BUILD
echo ================================================
echo.
...
REM --- 5. Construir ----------------------------------------------------
echo.
echo [..] Empaquetando TVPlayout PRO V24.0.1.7 (esto puede tardar 2-5 minutos)...
echo.
%PYEXE% -m PyInstaller ^
    --noconfirm ^
    --clean ^
